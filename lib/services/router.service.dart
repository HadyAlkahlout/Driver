...
import 'package:fuodz/views/pages/chat/simple_chat_page.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    //chat page - will be implemented with new chat system
    case AppRoutes.chatRoute:
      final order = settings.arguments as Order;
      return MaterialPageRoute(
        settings: RouteSettings(name: AppRoutes.chatRoute),
        builder: (context) => SimpleChatPage(order: order),
      );
