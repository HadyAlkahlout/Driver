      ...
      body: ViewModelBuilder<OrderDetailsViewModel>.reactive(
        ...
        builder: (context, vm, child) {
          return BasePage(
            ...
            actions: [
              // topup custom wallet
              TopupCustomerWalletButton(vm.order),
            ],
            body:
                vm.isBusy
                    ...
                    : VStack(
                      [
                        ...
                        //shop address with location button only
                        HStack([
                          VStack([
                            "Shop Address".tr().text.gray500.medium.sm.make(),
                          ...
                          if (vm.order.canChatCustomer &&
                            ...
                            HStack([
                              ...
                              CustomButton(
                                ...
                                onPressed: () async {
                                  try {
                                    // Use ZegoCloud video calling service like in chat
                                    final customerId = 'customer_${vm.order.user.id}';
                                    await vm.makeVideoCallToCustomer(customerId, vm.order.user.name);
                                  } catch (e) {
                        ...
                        VStack([
                          ...
                          vm.order.isPackageDelivery
                              ...
                              : CustomListView(
                                ...
                                separatorBuilder: (_, __) => 2.heightBox,
