    ...
    return VStack([
      ...
      VStack([
        ...
        "Once you grant this permission, you won't be asked again unless you revoke it in system settings."
            ...
            .makeCentered(),
        UiSpacer.vSpace(),
      ], crossAlignment: CrossAxisAlignment.center).scrollVertical().expand(),
      CustomButton(
        shapeRadius: 25,
      ...
      Visibility(
        ...
        child: CustomTextButton(
          ...
          onPressed: () async {
            await widget.vm.skipOverlayPermission();
          },
        ).wFull(context),
      ),
      UiSpacer.vSpace(10),
      Visibility(
        ...
        child: CustomTextButton(
          ...
          onPressed: () async {
            await widget.vm.permanentlyDisableOverlayPermission();
          },
        ).wFull(context),
      ),
      UiSpacer.vSpace(10),
