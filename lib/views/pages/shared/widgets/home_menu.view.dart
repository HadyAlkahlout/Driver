          ...
          children: [
            VStack([
                  ...
                  VStack([
                    ...
                    MenuItem(title: "Faqs".tr(), onPressed: model.openFaqs),
                    ...
                    MenuItem(
                      title: "Language".tr(),
                      divider: false,
                      suffix: Icon(FlutterIcons.language_ent),
                  ...
                  //
                  ("Version".tr() + " - ${model.appVersionInfo}").text.center.sm
                      .makeCentered()
                      .py20(),
                ])
                .p(18)
            ...
            //close
            IconButton(
              icon: Icon(FlutterIcons.close_ant, color: Colors.white),
              onPressed: () {
                context.pop();
              },
