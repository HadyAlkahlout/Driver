...
class _VideoCallTestPageState extends State<VideoCallTestPage> {
  ...
  void initState() {
    super.initState();
    // Set default values for testing (Driver calling Customer)
    _receiverIdController.text = "customer_4"; // Customer ID
    _receiverNameController.text = "Client Account";
  }
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      labelText: 'Receiver ID (Customer ID)',
                      hintText: 'e.g., customer_4',
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                    '1. Make sure both Driver and Customer apps are running\n'
                    '2. Enter Customer ID (e.g., "customer_4") in Receiver ID\n'
                    '3. Enter Customer name in Receiver Name\n'
                    '4. Click "Video Call" button\n'
                    '5. Driver outgoing call screen should appear\n'
                    '6. Customer app should receive incoming call',
                    style: TextStyle(
                      color: Colors.orange.shade700,
                      height: 1.4,
                    ),
