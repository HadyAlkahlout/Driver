...
import 'package:fuodz/view_models/driver/docs_vm.dart';
import 'package:fuodz/views/pages/auth/driver/tax_page.dart';
                ...
                children: [
                                ...
                                children: [
                                  ...
                                  Visibility(
                                    ...
                                    child: Row(
                                      children: [
                                        Text(
                                          'Click again to choose a new file',
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Expanded(
                                        child: Text(
                                          'Vehicle Registration (if using a car)',
                                          style:
                                              Theme.of(
                                                context,
                                              ).textTheme.bodyMedium,
                                  ...
                                  Visibility(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Spacer(),
                                        Text(model.vehicleRegistrationName),
                                      ],
                                    ),
                                  ),
                                ],
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Expanded(
                                        child: Text(
                                          'Selfie photo holding their ID (for face match)',
                                          style:
                                              Theme.of(
                                                context,
                                              ).textTheme.bodyMedium,
                                  ...
                                  Visibility(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Spacer(),
                                        Text(model.criminalRecordsName),
                                      ],
                                    ),
                                  ),
                                ],
                  ...
                  Align(
                    ...
                    child: GestureDetector(
                      ...
                      child: Card(
                        color: Vx.gray200.withOpacity(model.canNext ? 0.3 : 0.8),
